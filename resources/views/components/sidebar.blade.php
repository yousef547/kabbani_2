              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i data-feather="box"></i><span>Product Catalog</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('category')}}">Categories</a></li>
                      <li><a href="{{route('subCategory')}}">Sub Categories</a></li>

                      <li><a href="{{route('porducts')}}">Products</a></li>
                      <li><a href="projects.html">Attributes</a></li>
                      <li><a href="projectcreate.html">Options</a></li>
                      <li><a href="projects.html">Connected Types</a></li>
                      <li><a href="projectcreate.html">Inventory</a></li>
                      <li><a href="projects.html">Warehouse</a></li>
                      <li><a href="projectcreate.html">Vendors</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="file-manager.html"><i class="fa fa-shopping-cart me-3"></i><span>Orders</span></a></li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i class="fa fa-users me-3"></i><span>Customer</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="projects.html">Customers</a></li>
                      <li><a href="projectcreate.html">Groups</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="layout"></i><span class="lan-7">Page layout</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="box-layout.html">Boxeddddd</a></li>
